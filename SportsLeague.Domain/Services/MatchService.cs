...
{
    // Se inyectan los repositorios necesarios para validar las reglas de negocio (6)
    ...
    public async Task<IEnumerable<Match>> GetAllByTournamentAsync(int tournamentId)
    {
        ...
        _logger.LogInformation("Retrieving match with TournamentID: {TournamentId}", tournamentId);
